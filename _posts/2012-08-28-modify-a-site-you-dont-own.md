...
(like [jsdom](http://blog.nodejitsu.com/jsdom-jquery-in-5-lines-on-nodejs)) rely on.  Please consider donating time into improving tautologistics' htmlparser. One small fix will improve many node libraries.
